...
func TestGoDb_HSet(t *testing.T) {
	t.Run("fileio", func(t *testing.T) {
		testGoDbHSet(t, FileIO, KeyOnlyMemMode)
	})
	t.Run("mmap", func(t *testing.T) {
		testGoDbHSet(t, MMap, KeyValueMemMode)
	})
	t.Run("mmap-key-only", func(t *testing.T) {
		testGoDbHSet(t, MMap, KeyOnlyMemMode)
	})
}

func testGoDbHSet(t *testing.T, ioType IOType, mode DataIndexMode) {
...
func TestGoDb_HSetNX(t *testing.T) {
	t.Run("fileio", func(t *testing.T) {
		testGoDbHSetNX(t, FileIO, KeyOnlyMemMode)
	})
	t.Run("mmap", func(t *testing.T) {
		testGoDbHSetNX(t, MMap, KeyValueMemMode)
	})
}

func testGoDbHSetNX(t *testing.T, ioType IOType, mode DataIndexMode) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	opts.IoType = ioType
	opts.IndexMode = mode
...
func TestGoDb_HGet(t *testing.T) {
	t.Run("fileio", func(t *testing.T) {
		testGoDbHGet(t, FileIO, KeyOnlyMemMode)
	})
	t.Run("mmap", func(t *testing.T) {
		testGoDbHGet(t, MMap, KeyValueMemMode)
	})
}

func testGoDbHGet(t *testing.T, ioType IOType, mode DataIndexMode) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	opts.IoType = ioType
	opts.IndexMode = mode
...
func TestGoDb_HMGet(t *testing.T) {
	t.Run("fileio", func(t *testing.T) {
		testGoDbHMGet(t, FileIO, KeyOnlyMemMode)
	})
	t.Run("mmap", func(t *testing.T) {
		testGoDbHMGet(t, MMap, KeyValueMemMode)
	})
}

func testGoDbHMGet(t *testing.T, ioType IOType, mode DataIndexMode) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	opts.IoType = ioType
	opts.IndexMode = mode
...
func TestGoDb_HDel(t *testing.T) {
	t.Run("fileio", func(t *testing.T) {
		testGoDbHDel(t, FileIO, KeyOnlyMemMode)
	})
	t.Run("mmap", func(t *testing.T) {
		testGoDbHDel(t, MMap, KeyValueMemMode)
	})
}

func testGoDbHDel(t *testing.T, ioType IOType, mode DataIndexMode) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	opts.IoType = ioType
	opts.IndexMode = mode
...
func TestGoDb_HExists(t *testing.T) {
	t.Run("fileio", func(t *testing.T) {
		testGoDbHExists(t, FileIO, KeyOnlyMemMode)
	})
	t.Run("mmap", func(t *testing.T) {
		testGoDbHExists(t, MMap, KeyValueMemMode)
	})
}

func testGoDbHExists(t *testing.T, ioType IOType, mode DataIndexMode) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	opts.IoType = ioType
	opts.IndexMode = mode
...
func TestGoDb_HLen(t *testing.T) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	db, err := Open(opts)
	assert.Nil(t, err)
...
func TestGoDb_DiscardStat_Hash(t *testing.T) {
...
func TestGoDb_HashGC(t *testing.T) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	opts.LogFileSizeThreshold = 64 << 20
	db, err := Open(opts)
...
func TestGoDb_HKeys(t *testing.T) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	db, err := Open(opts)
	assert.Nil(t, err)
...
func TestGoDb_HVals(t *testing.T) {
	cases := []struct {
		IOType
		DataIndexMode
	}{
...
func TestGoDb_HGetAll(t *testing.T) {
	cases := []struct {
		IOType
		DataIndexMode
	}{
...
func TestGoDb_HStrLen(t *testing.T) {
	cases := []struct {
		IOType
		DataIndexMode
	}{
...
func TestGoDb_HScan(t *testing.T) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	db, err := Open(opts)
	assert.Nil(t, err)
...
func TestGoDb_HIncrBy(t *testing.T) {
	cases := []struct {
		IOType
		DataIndexMode
	}{
...
func TestGoDb_HRandField(t *testing.T) {
	cases := []struct {
		IOType
		DataIndexMode
	}{
