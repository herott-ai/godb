...
func TestGoDb_SAdd(t *testing.T) {
	t.Run("fileio", func(t *testing.T) {
		testGoDbSAdd(t, FileIO, KeyValueMemMode)
	})
	t.Run("mmap", func(t *testing.T) {
		testGoDbSAdd(t, MMap, KeyOnlyMemMode)
	})
}

func testGoDbSAdd(t *testing.T, ioType IOType, mode DataIndexMode) {
...
func TestGoDb_SPop(t *testing.T) {
	t.Run("fileio", func(t *testing.T) {
		testGoDbSPop(t, FileIO, KeyOnlyMemMode)
	})
	t.Run("mmap", func(t *testing.T) {
		testGoDbSPop(t, MMap, KeyValueMemMode)
	})
}

func testGoDbSPop(t *testing.T, ioType IOType, mode DataIndexMode) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	opts.IoType = ioType
	opts.IndexMode = mode
...
func TestGoDb_SRem(t *testing.T) {
	t.Run("fileio", func(t *testing.T) {
		testGoDbSRem(t, FileIO, KeyOnlyMemMode)
	})
	t.Run("mmap", func(t *testing.T) {
		testGoDbSRem(t, MMap, KeyValueMemMode)
	})
}

func testGoDbSRem(t *testing.T, ioType IOType, mode DataIndexMode) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	opts.IoType = ioType
	opts.IndexMode = mode
...
func TestGoDb_SIsMember(t *testing.T) {
	t.Run("fileio", func(t *testing.T) {
		testGoDbSIsMember(t, FileIO, KeyOnlyMemMode)
	})
	t.Run("mmap", func(t *testing.T) {
		testGoDbSIsMember(t, MMap, KeyValueMemMode)
	})
}

func testGoDbSIsMember(t *testing.T, ioType IOType, mode DataIndexMode) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	opts.IoType = ioType
	opts.IndexMode = mode
...
func TestGoDb_SMembers(t *testing.T) {
	t.Run("fileio", func(t *testing.T) {
		testGoDbSMembers(t, FileIO, KeyOnlyMemMode)
	})
	t.Run("mmap", func(t *testing.T) {
		testGoDbSMembers(t, MMap, KeyValueMemMode)
	})
}

func testGoDbSMembers(t *testing.T, ioType IOType, mode DataIndexMode) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	opts.IoType = ioType
	opts.IndexMode = mode
...
func TestGoDb_SCard(t *testing.T) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	db, err := Open(opts)
	assert.Nil(t, err)
...
func TestGoDb_DiscardStat_Sets(t *testing.T) {
...
func TestGoDb_SetGC(t *testing.T) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	opts.LogFileSizeThreshold = 64 << 20
	db, err := Open(opts)
...
func TestGoDb_SDiff(t *testing.T) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	db, err := Open(opts)
	assert.Nil(t, err)
...
func TestGoDb_SDiffStore(t *testing.T) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	db, err := Open(opts)
	assert.Nil(t, err)
...
func TestGoDb_SUnion(t *testing.T) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	db, err := Open(opts)
	assert.Nil(t, err)
...
func TestGoDb_SUnionStore(t *testing.T) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	db, err := Open(opts)
	assert.Nil(t, err)
...
func TestGoDb_SInter(t *testing.T) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	db, err := Open(opts)
	assert.Nil(t, err)
...
func TestGoDb_SInterStore(t *testing.T) {
	path := filepath.Join("/tmp", "godb")
	opts := DefaultOptions(path)
	db, err := Open(opts)
	assert.Nil(t, err)
